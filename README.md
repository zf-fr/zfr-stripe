...
The currently latest supported version of the API is **2014-11-05**. You can (and should) also explicitly specify the version
of the client using the second parameter:

```php
$client = new StripeClient('my-api-key', '2014-11-05');
```
...
`2014-06-17`, `2014-07-22`,  `2014-07-26`,  `2014-08-04`, `2014-08-20`, `2014-09-08`. `2014-10-07`. `2014-11-05`. I
will try to update the library as soon as new version are released.
