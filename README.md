...
The currently latest supported version of the API is **2015-06-15**. You can (and should) also explicitly specify the version
of the client using the second parameter:

```php
$client = new StripeClient('my-api-key', '2015-06-15');
```
...
`2015-02-18`, `2015-03-24`, `2015-04-07`, `2015-06-15`. I will try to update the library as soon as new version are released.
