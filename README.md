...
The currently latest supported version of the API is **2014-11-20**. You can (and should) also explicitly specify the version
of the client using the second parameter:

```php
$client = new StripeClient('my-api-key', '2014-11-20');
```
...
`2014-11-20`. I will try to update the library as soon as new version are released.
